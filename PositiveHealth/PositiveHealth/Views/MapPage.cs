...
namespace PositiveHealth.Views
{
    public class MapPage : ContentPage
    {
            ...
            // map.MoveToRegion(new MapSpan(new Position(0, 0), 360, 360));
                ...
                // slider to zoom in and out of map
                    var slider = new Slider(1, 18, 1);
                    slider.ValueChanged += (sender, e) =>
                {
                    var zoomLevel = e.NewValue; // between 1 and 17
                ...
                var gps = new Button { Text = "GPS" };
                street.Clicked += HandleClicked;
                hybrid.Clicked += HandleClicked;
                satellite.Clicked += HandleClicked;
                gps.Clicked += GpsClicked;
                ...
                var segments = new StackLayout
                {
                    ...
                    Children = { street, hybrid, satellite, gps }
                };
